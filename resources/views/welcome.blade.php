...
<body class="">
    ...
    <div id="gallery" class="relative w-full" data-carousel="slide">
        ...
        <div class='absolute top-0 z-30 w-full'>
            <div x-data="{ atTop: false }">
                <nav class=" fixed w-full  bg-transparent border-gray-200 " :class="{ 'shadow-lg': atTop, 'bg-transparent text-white': !atTop, 'bg-white text-indigo-800': atTop }" @scroll.window="atTop = (window.pageYOffset < 50) ? false: true">
                    ...
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        ...
                        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                            <ul class="flex flex-col font-medium items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent">
                                ...
                                <li>
                                    <button id="dropdownNavbarLink2" data-dropdown-toggle="dropdownNavbar2" class="flex items-center justify-between w-full py-2 pl-3 pr-4  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent" :class="{  'text-gray-800 md:text-white ': !atTop, '  md:text-gray-800 ': atTop }">Nos campus <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                                        </svg></button>
                                    <!-- Dropdown menu -->
                                ...
                                <li>
                                    <a href="#" class="block py-2 pl-3 pr-4     rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" :class="{  'text-gray-800 md:text-white ': !atTop, '  md:text-gray-800 ': atTop }">Blog</a>
                                </li>
                                <li>
                                    <a href="#section4" class="block py-2 pl-3 pr-4   rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" :class="{  'text-gray-800 md:text-white ': !atTop, '  md:text-gray-800 ': atTop }" >Galerie</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class='relative bg-black'>
        ...
        <div class="p-3 h-auto bg-gray-100">
            ...
            <div class="md:p-11 justify-center items-center  relative md:-translate-y-28 flex flex-col md:flex-row">
                ...
                <div class="bg-white h-auto w-full shadow p-11 md:-translate-x-14 md:translate-y-12  md:w-2/5  md:h-4/6 ">
    ...
    <div id="section22" class="p-11">
        <div class="section2 text-center flex items-center justify-center flex-col md:p-11">
            ...
            <p class="tracking-widest w-full text-sm md:w-1/3 text-gray-500 md:text-lg dark:text-gray-400">Praesentium ipsam exercitationem consequatur dolorum Praesentium ipsam exercitationem consequatur dolorum.</p>
        </div>
    </div>
